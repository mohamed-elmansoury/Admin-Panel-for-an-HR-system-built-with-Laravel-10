...
return new class extends Migration
{
    ...
    {
        Schema::create('admin_panel_sittings', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('after_minute_calculate_delay',10,2)->default(0)->comment("بعد كم دقيقة نحسب تاخير حضور	");
            $table->decimal('after_minute_calculate_early_departure',10,2)->default(0)->comment("بعد كم دقيقة نحسب انصراف مبكر	");
            $table->decimal('after_minute_quarterday',10,2)->default(0)->comment("بعد كم دقيقه مجموع الانصارف المبكر او الحضور المتأخر نحصم ربع يوم	");
            $table->decimal('after_time_half_deduct',10,2)->default(0)->comment("بعد كم مرة تأخير او انصارف مبكر نخصم نص يوم	");
            $table->decimal('after_time_allday_deduct',10,2)->default(0)->comment("نخصم بعد كم مره تاخير او انصارف مبكر يوم كامل	");
    ...
    {
        Schema::dropIfExists('admin_panel_sittings');
    }
};
