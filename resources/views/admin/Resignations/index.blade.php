    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title card_title_center"> اسباب ترك العمل
                    <a href="{{ route('Resignations.create') }}" class="btn btn-sm btn-warning">اضافة جديد</a>
                </h3>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($data as $info)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Delete Form -->
                                        <form action="{{ route('Resignations.destroy', $info->id) }}" method="POST"
