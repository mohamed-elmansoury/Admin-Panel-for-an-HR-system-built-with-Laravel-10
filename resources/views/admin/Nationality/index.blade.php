    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title card_title_center"> جنسيات الموظفين  
                    <a href="{{ route('Nationality.create') }}" class="btn btn-sm btn-warning">اضافة جديد</a>
                </h3>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($data as $info)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Delete Form -->
                                        <form action="{{ route('Nationality.destroy', $info->id) }}" method="POST"
