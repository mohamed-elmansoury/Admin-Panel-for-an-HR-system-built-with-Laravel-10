...
<a href="{{ route('JopCategories.index') }}">    الوظيفه</a>
@endsection
...
<div class="col-12">
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  تعديل بيانات الوظيفه
         </h3>
      </div>
      <div class="card-body">
         <form action="{{ route('JopCategories.update',$data['id']) }}" method="post">
            @csrf
            @method('PUT')
            ...
            <div class="col-md-12">
               <div class="form-group text-center">
                  <button class="btn btn-sm btn-success" type="submit" >تعديل الاداره </button>
