        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title card_title_center"> بيانات الوظائف
                    <a href="{{ route('JopCategories.create') }}" class="btn btn-sm btn-warning">اضافة جديد</a>
                </h3>
            </div>
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($info->updated_by > 0)
                                            {{ $info->updatedby->name }} <br>
                                            {{ \Carbon\Carbon::parse($info->updated_at)->toDateString() }}
                                        @else
                                            لايوجد
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('JopCategories.edit', $info->id) }}" method="GET"
                                        ...
                                        <!-- Delete Form -->
                                        <form action="{{ route('JopCategories.destroy', $info->id) }}" method="POST"
                                            style="display:inline;"
