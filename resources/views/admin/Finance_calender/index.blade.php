               ...
               <tr>
                  ...
                  <td>
                    ...
                    @endif
                     ...
                     <form action="{{ route('finance_calender.destroy', $info->id) }}" method="POST" style="display: none;" id="delete-form-{{ $info->id }}">
                        @csrf
                        @method('DELETE')
                    </form>
                    
                    <a class="btn are_you_shur  btn-danger btn-sm" href="#" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $info->id }}').submit();">
                        حذف 
                    </a>
